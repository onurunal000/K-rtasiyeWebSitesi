...
/*!**************************************************!*\
  !*** ./src/assets/js/pages/horizontal-layout.js ***!
  \**************************************************/
...
function listener() {
  ...
  menuItems.forEach(function (menuItem) {
    menuItem.querySelector('.menu-link').addEventListener('click', function (e) {
      e.preventDefault();
  ...
  var submenuItems = document.querySelectorAll('.submenu-item.has-sub');
  submenuItems.forEach(function (submenuItem) {
    submenuItem.querySelector('.submenu-link').addEventListener('click', function (e) {
      e.preventDefault();
